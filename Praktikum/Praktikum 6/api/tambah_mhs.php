...
$tgl_lahir     = $conn->real_escape_string($data['tgl_lahir'] ?? '');
$jam_bimbingan = $conn->real_escape_string($data['jam_bimbingan'] ?? '');
...
// Simpan ke database
$sql = "INSERT INTO mahasiswa (nama, npm, email, alamat, tgl_lahir, jam_bimbingan)
