  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/dosen': (_) => const DaftarDosenPage(),
        '/matakuliah': (_) => const DaftarMatakuliahPage(),
...
class DaftarDosenPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: const Center(child: Text("Halaman daftar dosen masih kosong.")),
    );
  }
}

class DaftarMatakuliahPage extends StatelessWidget {
  const DaftarMatakuliahPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Daftar Matakuliah")),
      body: const Center(child: Text("Halaman daftar matakuliah masih kosong.")),
    );
  }
}